...
function startRadarTicks(opts = {}) {
  const {
    ...
    log = console.log, planifier = setInterval,
  } = opts;
  ...
  return { actif: true, raison: 'ok', minutes: m, dir: plan.dir, stop: () => clearInterval(h), _tick: tick };
}

module.exports = { planRadarStorage, applyRadarStorage, planTick, startRadarTicks, MARQUEUR };
