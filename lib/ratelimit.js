...
/* `envNum` est exporte parce qu'un deuxieme appelant en avait besoin (lib/radar-tick.js) et que ce depot
 * a paye sept fois le motif « le helper correct existe, l'appelant a fort enjeu en ecrit une copie plus
 * faible ». Ajout pur: aucun comportement de rate-limit ne change. */
module.exports = { rateLimit, clientIdentity, envNum, _hits: hits };
