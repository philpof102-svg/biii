...
function checkLink(url) {
  ...
  return { ok: true, url, hostname: host, registrable: reg, impersonates: [], browserNative: false,
    ...facts,
    verdict: 'unrecognised', reason: 'Domain "' + reg + '" is not a platform this recognises. That is not an accusation — but combined with any request to install something, treat it as the answer.' + factsNote(facts) };
}
