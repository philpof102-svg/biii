 ...
 */
function renderRoll(rows, { merchantName = 'Merchant', lang = 'en', window } = {}) {
...
module.exports = { renderReceipt, appendReceipt, summary, reverify, reverifyRoll, renderRoll, receiptNo };
