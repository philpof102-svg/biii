 ...
 * limit: 121 of 221 launches had a traceable funder, so this answers nothing about the other 45% and says
...
function assess(registry, funder, opts = {}) {
  if (!funder) {
    return {
      ...
      reason: 'the wallet that paid for this launch could not be traced, so this check has nothing to say. '
        + 'That is not a clearance: 45% of the launches we watch are in this state, and they rug at roughly '
        + 'the population rate.',
